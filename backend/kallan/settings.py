...
WSGI_APPLICATION = "kallan.wsgi.application"


DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.environ.get("DB_NAME", "kallan"),
        "USER": os.environ.get("DB_USER", "kallan"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "kallan"),
